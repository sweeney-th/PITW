...
# Generally, Perl programs should starts like this:
use strict;
use warnings;
...
# you need to add the "\n" explicitly, and mind the ;
print "Hello World\n";

# you can add  ( ) if you like, to help compartmentalize
...
# next, we will look at types in Perl
