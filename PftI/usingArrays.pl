...
# with it". the more modern, Pythonic way to it is:
...
# going to notice in most computaions.
...
# function to answer this burning qeustion
...
# general refference text. google the PDF version; that tis libre
