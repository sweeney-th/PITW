...
# flow (with a few wierd but mangeable quirks for comparisons)
my $number = 7;
...
# else allows us to brach our logic to accounts for more options
if($number < 7) {
...
# number of ellsifs - knock your self out
...
# some lanugages do and if there where more then phrase you would need it
